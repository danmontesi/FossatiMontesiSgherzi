...
\end{itemize}
The user can receive notifications in the Smartwatch and delete them through it.
\newline
...
\textbf{Data4Help Core:} This component does not have a user interface since it is intended to be accessible only by the staff